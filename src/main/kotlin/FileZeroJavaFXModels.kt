...
fun createMapMesh(size: Double, color: Color): Mesh {
    ...
    val blushes = listOf(
        AABB(min = Vector3d(47.0 * hs, 10.0 * hs, 20.0 * hs), max = Vector3d(53.0 * hs, 1.0E-4 * hs, 30.0 * hs)),
        AABB(min = Vector3d(97.0 * hs, 10.0 * hs, 20.0 * hs), max = Vector3d(103.0 * hs, 1.0E-4 * hs, 30.0 * hs)),
        AABB(min = Vector3d(-3.0 * hs, 10.0 * hs, 15.0 * hs), max = Vector3d(3.0 * hs, 1.0E-4 * hs, 35.0 * hs)),
    )
